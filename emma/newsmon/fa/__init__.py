...
def fa_mine_hard_neg(args) -> int:
    """
    ./newsmon fa mine_hard_neg -c mulabel -l sl
    """
    compute_arg_collection_name(args)
    models = EmbeddingModelWrapperFactory.init_models(args)
    labeler = init_labeler(args)
...
def fa_test_rae(args) -> int:
    """
    ./newsmon fa test_rae -c mulabel -l sl --public --ptm_models bge_m3,jinav3,gte
    """
    compute_arg_collection_name(args)
    models = EmbeddingModelWrapperFactory.init_models(args)
    labeler = init_labeler(args)
...
def fa_test_zshot(args) -> int:
    """
    ./newsmon fa test_zshot -c mulabel -l sl --public --ptm_models bge_m3,jinav3,gte
    """
    compute_arg_collection_name(args)
    models = EmbeddingModelWrapperFactory.init_models(args)
    labeler = init_labeler(args)
...
def fa_test_mlknn(args) -> int:
    """
    ./newsmon fa test_mlknn -c mulabel -l sl --public --ptm_models bge_m3,jinav3,gte
    """
